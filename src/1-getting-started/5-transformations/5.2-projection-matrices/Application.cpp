...
int main()
{
  ...
  //! Scope ensures proper destruction order of OpenGL objects before context is destroyed
  {
    ...
    // clang-format off
    float vertices[] = {
        -200.0f,  200.0f, 0.0f, 0.8f, 0.3f, 0.3f, 0.0f, 0.0f, // Top-left
        200.0f,  200.0f, 0.0f, 0.2f, 0.4f, 0.3f, 1.0f, 0.0f, // Top-right
        200.0f, -200.0f, 0.0f, 0.1f, 0.3f, 0.7f, 1.0f, 1.0f, // Bottom-right
        -200.0f, -200.0f, 0.0f, 0.2f, 0.8f, 0.1f, 0.0f, 1.0f, // Bottom-left
    };
    // clang-format on
    ...
    // Usa un rango más amplio para permitir más movimiento
    ...
    Shader shader("../../src/1-getting-started/5-transformations/5.2-projection-matrices/shaders/Shaders.shaders");
    ...
    // definimos como empieza la translacion(esta rotando)
    glm::vec3 translation(400, 400, 0); // starts in front of the camera
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      {
        ImGui::SliderFloat3("Translation", &translation.x, 390.0f, 410.0f);
