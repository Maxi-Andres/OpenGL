...
int main()
{
  ...
  //! Scope ensures proper destruction order of OpenGL objects before context is destroyed
  {
    ...
    Shader shader("../../src/2-lighting/1-colors-and-2-basic-lighting/1.1-crazy-sun/shaders/Shaders.shaders");
    shader.Bind();
    ...
    // ======================= LIGHT =======================
    Shader lightShader("../../src/2-lighting/1-colors-and-2-basic-lighting/1.1-crazy-sun/shaders/LightShaders.shaders");
    lightShader.Bind();
